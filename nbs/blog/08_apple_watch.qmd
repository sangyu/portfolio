...
*Health is multidimensional; Recovery is not a single number.*
...
<div class="apple-watch-float-embed">
  <iframe src="https://observablehq.com/embed/76e9efc2ca04150f?cells=state_space_asymmetry"></iframe>
...
<div style="margin: 2rem 0;">
  <iframe width="100%" height="380" frameborder="0"
    src="https://observablehq.com/embed/76e9efc2ca04150f?cells=interactive3d"></iframe>
</div>
```
...
With double support time as the locomotor axis, the loop stays open. That changes the interpretation. My resting heart rate looks closer to baseline, and my walking asymmetry has mostly resolved, but another part of my gait still has not. This may help explain why the VO₂ max estimate remains stubbornly low: the limiting factor may not be cardiovascular recovery. alone, but movement efficiency. Recovery is not a single number. It depends on which measurement you trust to stand in for the thing you care about.
