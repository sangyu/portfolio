...
# Serotonin and how we patiently choose to wait

*Serotonin at the moment of choice.*

Throw back to the time I built a mouse decision-making task to ask when serotonin changes a choice: before waiting begins, at the moment an animal decides whether a larger future reward is worth the delay, circa 2016.

::: {style="float:right; width:50%; margin-left:1.5em; margin-bottom:1em;"}
![](../images/blog/03_itc_files/xu2017fig1.jpg)
:::
...
::: {style="float:left; width:40%; margin-right:1.5em; margin-bottom:1em;"}
<video src="../images/blog/03_itc_files/itc.mp4" autoplay muted loop playsinline style="width:100%; border-radius:4px;"></video>
:::
...
[Xu et al. (2017) *Current Biology* — Dorsal Raphe Serotonergic Neurons Control Intertemporal Choice under Trade-off &nearr;](https://pubmed.ncbi.nlm.nih.gov/28988863/)

<div style="margin-top:3rem;padding-top:1rem;border-top:1px solid #e0d5c5;font-size:0.85rem;color:#999;">
This work was done in collaboration with Gishnu Das, <a href="http://www.graybiel-lab.com/emily-hueske.html" target="_blank">Emily Hueske</a>, and <a href="https://tonegawalab.mit.edu/susumu-tonegawa/" target="_blank">Susumu Tonegawa</a>.
</div>
