...
<a href="../images/blog/ethomics_phenovectors.png" class="lightbox"><img src="../images/blog/ethomics_phenovectors.png" class="img-fluid" alt="Phenovectors of serotonergic manipulations clustered by their full behavioral profile. Some manipulations align with the natural hunger-satiety transition; others change one readout while the rest of the profile stays discordant."></a>
<p style="margin-top:0.6rem; font-size:0.82rem; color:var(--warm-grey); line-height:1.5;">Each manipulation placed by its full phenovector rather than a single readout. Coherent state changes line up with the natural hunger–satiety axis; effects that move only one metric scatter away from it.</p>
</div>
...
*This piece extends the ideas in [Contextualized Ethomics](02_ethomics.html). The full study is on [bioRxiv &nearr;](https://doi.org/10.64898/2026.07.01.735755).*
